...
import { STVehicle } from './STVehicle';
...
@ccclass('STSteeredVehicle')
export class STSteeredVehicle extends STVehicle {
    @property
    maxForce: number = 1
    @property
    ...
    pursueOffset(target: STVehicle, offset: Vec2): void {
    ...
    private inSight(vehicle: STVehicle) {
